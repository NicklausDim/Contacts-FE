    ...
    function Contacts() {
        ...
        const url = 'https://contacts-backend-v1.herokuapp.com/contacts/new';
        const options = {
            method: 'POST',
            headers: {
            'x-auth-token': localStorage.getItem('token')
        ...
        useEffect(() => {
        const url = 'https://contacts-backend-v1.herokuapp.com/contacts/all';
        const options = {
            headers
        }
        ...
        const url = 'https://contacts-backend-v1.herokuapp.com/contacts/'+id;
        const options = {
            method: 'DELETE',
            headers
        }
