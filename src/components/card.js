...
const Card = ({contact, deleteContact}) => {
    ...
    const updateContactHandler = () => {
        ...
        const url = 'https://contacts-backend-v1.herokuapp.com/contacts/update';
        const options = {
        method: 'POST',
        headers: {
    ...
    return(
        <div className='card' style={{backgroundColor: bgColor}}>
            {isEditable?<input data-id="file" type="file" onChange= {editCardHandler}/>:<img src = {"https://contacts-backend-v1.herokuapp.com/avatars/" + avatar}/>}
